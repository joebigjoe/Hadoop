...
conf = SparkConf().setMaster("local").setAppName("Highest Temp")
...
rdd_min_groupby_station = rdd_min_list.groupByKey()
rdd_min_groupby_station_ordered = rdd_min_groupby_station.mapValues(lambda x: sorted(x, reverse=True)[0])
print(rdd_min_groupby_station_ordered.collect())